...
<head>
    ...
    <meta name="description" content="Découvrez comment le transport durable peut réduire l'impact environnemental tout en optimisant vos trajets.">
    <title>Transport Durable - Découvrir Plus</title>
        ...
        <section>
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <a href="trajets_partages.php" class="btn btn-primary">Découvrir notre impact écologique</a>
                </div>
            </div>
        </section>
