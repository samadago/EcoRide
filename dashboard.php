    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="container mt-5">
                <h1 class="text-center">Panel Admin - EcoRide</h1>
                ...
                <div class="card my-4">
                    <div class="card-header d-flex align-items-center">
                        <h2 class="mb-0 me-auto">Utilisateurs</h2> <!-- Ajout de "me-auto" pour pousser le bouton à droite -->
                        <button class="btn btn-success ms-4" data-bs-toggle="modal" data-bs-target="#addUserModal">Ajouter</button>
                    </div>
                </div>
            ...
            <div class="card my-4">
                <div class="card-header d-flex align-items-center">
                    <h2 class="mb-0 me-auto">Chauffeurs</h2> <!-- Ajout de "me-auto" pour pousser le bouton à droite -->
                    <button class="btn btn-success ms-4" data-bs-toggle="modal" data-bs-target="#addUserModal">Ajouter</button>
                </div>
            </div>
        ...
        <div class="card my-4">
            <div class="card-header d-flex align-items-center">
                <h2 class="mb-0 me-auto">Covoiturages</h2> <!-- Ajout de "me-auto" pour pousser le bouton à droite -->
                <button class="btn btn-success ms-4" data-bs-toggle="modal" data-bs-target="#addUserModal">Ajouter</button>
            </div>
        </div>
